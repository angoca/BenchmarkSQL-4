...
static void initJDBC() {
  ...
  try {
    ...
    orlnPrepStmt = conn.prepareStatement
      ("INSERT INTO " + ini.getProperty("schema") + "order_line " +
    ...
    nworPrepStmt = conn.prepareStatement
      ("INSERT INTO " + ini.getProperty("schema") + "new_order " +
       " (no_w_id, no_d_id, no_o_id) " +
       "VALUES (?, ?, ?)");

    stckPrepStmt = conn.prepareStatement
      ("INSERT INTO " + ini.getProperty("schema") + "stock " +
    ...
    whsePrepStmt = conn.prepareStatement
       ("INSERT INTO " + ini.getProperty("schema") + "warehouse " +
